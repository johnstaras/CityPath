...
import FavoritesListScreen from '../views/favorites/FavoritesListScreen';
...
export type FavoritesStackParamList = {
  ...
  // Routes can be started (and therefore finished) from this tab too — the
  // summary must exist here or completion's replace() dead-ends.
...
function FavoritesStack(): React.JSX.Element {
  return (
